...
public class EnrollActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new SendPostJson().execute("http://14.63.161.4:26533/newuser");
    ...
    //for 서버로 post전송
    public class SendPostJson extends AsyncTask<String, String, String>{
        @Override
...
//                String id = result.substring(1,10);

                ed.putString("userId", result); // value : 저장될 값,
                ed.commit();

                String getUserID = pref.getString("userId", "없음");
                Log.d("저장테스트","아이디 : "+getUserID);
